            ...
            <div class="modal-body">
                <form method="POST" action="/home/update" enctype="multipart/form-data">
                    ...
                    <div class=" row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="FIO" type="text"
                                   class="form-control text-black @error('FIO') is-invalid @enderror" name="FIO"
                                   value="{{$user->FIO}}" autocomplete="FIO" autofocus>
                            @error('FIO')
                    ...
                    <div class=" row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="phone" value="{{$user->phone}}" type="phone"
